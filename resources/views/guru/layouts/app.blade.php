        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('guru.dashboard') }}" class="nav-item nav-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="{{ route('guru.pembimbing') }}" class="nav-item nav-link" {{ request()->routeIs('admin.pembimbing*') ? 'active' : '' }}  ><i class="fa fa-table me-2"></i>Pembimbing</a>
